package com.abdigunawan.makeupme.ui.order.detailkonfirmasi
...
class DetailKonfirmasiOrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detail_konfirmasi_order)
        initToolbar()
        initDetail()
    }
