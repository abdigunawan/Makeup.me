package com.abdigunawan.makeupme.ui.profile.akun
...
class ProfileAccountFragment : Fragment(),ProfileMenuAdapter.ItemAdapterCallback {
    ...
    fun initDataDummy() {
        ...
        menuArrayList.add(ProfileMenuModel("Edit Alamat"))
        menuArrayList.add(ProfileMenuModel("Edit Password"))
        menuArrayList.add(ProfileMenuModel("Log Out"))
    }

    override fun onClick(v: View, data: ProfileMenuModel) {
        Toast.makeText(context, "kamu meng klik "+ data.title, Toast.LENGTH_SHORT).show()
    }
}